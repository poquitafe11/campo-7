...
type Feature = (typeof allHealthFeatures)[0];
...
export default function HealthPage() {
  ...
  const visibleFeatures = useMemo(() => {
    ...
    if (profile.rol === 'Admin') {
      return allHealthFeatures;
    }
    if (!profile.permissions) {
      return [];
    }
    return allHealthFeatures.filter(feature => profile.permissions![feature.href]);
  }, [profile]);

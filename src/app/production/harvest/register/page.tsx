                            ...
                            <form onSubmit={performanceForm.handleSubmit(handleAddPerformance)} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                     <FormField control={performanceForm.control} name="personnelCodes" render={({ field }) => (
                                        <FormItem><FormLabel>Códigos de Personal</FormLabel><FormControl><Textarea placeholder="Un código por línea..." {...field} rows={10}/></FormControl><FormMessage /></FormItem>
                                     )}/>
                                     <FormField control={performanceForm.control} name="jabas" render={({ field }) => (
                                        <FormItem><FormLabel>N° de Jabas</FormLabel><FormControl><Textarea placeholder="Un número por línea..." {...field} rows={10}/></FormControl><FormMessage /></FormItem>
                                     )}/>
                                </div>

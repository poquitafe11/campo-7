...
type Feature = (typeof allProductionFeatures)[0];
...
export default function ProductionPage() {
  ...
  const visibleFeatures = useMemo(() => {
    ...
    if (profile.rol === 'Admin') {
      return allProductionFeatures;
    }
    if (!profile.permissions) {
      return [];
    }
    return allProductionFeatures.filter(feature => profile.permissions![feature.href]);
  }, [profile]);

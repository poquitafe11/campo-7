...
export const ActivityRecordSchema = z.object({
    ...
    performance: z.coerce.number().min(0, "El rendimiento debe ser un número positivo."),
    clustersOrJabas: z.coerce.number().optional(),
    personnelCount: z.coerce.number().int().min(1, "Debe haber al menos una persona."),
    workdayCount: z.coerce.number().min(0, "Las jornadas deben ser un número positivo."),

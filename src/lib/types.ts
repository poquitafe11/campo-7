...
export const ActivityRecordSchema = z.object({
    ...
    performance: z.coerce.number().min(0, "El rendimiento debe ser un número no negativo.").default(0),
    clustersOrJabas: z.coerce.number().min(0).optional().transform(v => v || 0),
    personnelCount: z.coerce.number().int().min(1, "Debe haber al menos una persona."),
    workdayCount: z.coerce.number().min(0, "Las jornadas deben ser un número no negativo.").default(0),
    cost: z.coerce.number().min(0, "El costo debe ser un número no negativo.").default(0),
    shift: z.string().min(1, "El turno es requerido."),
    minRange: z.coerce.number().default(0),
    maxRange: z.coerce.number().default(0),

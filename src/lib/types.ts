...
export const ActivityRecordSchema = z.object({
    ...
    performance: z.any().transform(v => Number(v) || 0),
    clustersOrJabas: z.any().transform(v => Number(v) || 0),
    personnelCount: z.any().transform(v => Number(v) || 0),
    workdayCount: z.any().transform(v => Number(v) || 0),
    cost: z.any().transform(v => Number(v) || 0),
    shift: z.string().min(1, "El turno es requerido."),
    minRange: z.any().transform(v => Number(v) || 0),
    maxRange: z.any().transform(v => Number(v) || 0),
    pass: z.any().transform(v => Number(v) || 0),
